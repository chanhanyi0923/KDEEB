...
class MapDIf {
 public:
  ...
  virtual void create_table(const TSessionId& session, const std::string& table_name, const TRowDescriptor& row_desc, const TTableType::type table_type, const TCreateParams& create_params) = 0;
...
class MapDNull : virtual public MapDIf {
 public:
  ...
  void create_table(const TSessionId& /* session */, const std::string& /* table_name */, const TRowDescriptor& /* row_desc */, const TTableType::type /* table_type */, const TCreateParams& /* create_params */) {
    return;
  }
...
typedef struct _MapD_create_table_args__isset {
  _MapD_create_table_args__isset() : session(false), table_name(false), row_desc(false), table_type(true), create_params(false) {}
  bool session :1;
  bool table_name :1;
  bool row_desc :1;
  bool table_type :1;
...
class MapDClient : virtual public MapDIf {
 ...
 public:
  ...
  void create_table(const TSessionId& session, const std::string& table_name, const TRowDescriptor& row_desc, const TTableType::type table_type, const TCreateParams& create_params);
  void send_create_table(const TSessionId& session, const std::string& table_name, const TRowDescriptor& row_desc, const TTableType::type table_type, const TCreateParams& create_params);
...
class MapDMultiface : virtual public MapDIf {
 ...
 public:
  ...
  void create_table(const TSessionId& session, const std::string& table_name, const TRowDescriptor& row_desc, const TTableType::type table_type, const TCreateParams& create_params) {
    ...
    size_t i = 0;
    for (; i < (sz - 1); ++i) {
      ifaces_[i]->create_table(session, table_name, row_desc, table_type, create_params);
    }
    ifaces_[i]->create_table(session, table_name, row_desc, table_type, create_params);
  }
...
class MapDConcurrentClient : virtual public MapDIf {
 ...
 public:
  ...
  void create_table(const TSessionId& session, const std::string& table_name, const TRowDescriptor& row_desc, const TTableType::type table_type, const TCreateParams& create_params);
  int32_t send_create_table(const TSessionId& session, const std::string& table_name, const TRowDescriptor& row_desc, const TTableType::type table_type, const TCreateParams& create_params);
